...
def create_iteration_tables(input_tables, num_iterations, iteration_start=0):
    ...
    component_list_iterations = generate_iterations(component_list, index_name = 'ComponentID', index_description='Component_Name', num_iterations=num_iterations, iteration_start=iteration_start)

    return component_list_iterations
