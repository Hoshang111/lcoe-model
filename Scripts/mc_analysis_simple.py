...
def bangladesh_analysis(inputs):
     # %% ===========================================================
    ...
    def get_site_params(site_name):
        """"""
        site_dict = {}
        site_dict['site_name'] = str(inputs[0])
        site_dict['latitude'] = float(inputs[1])
        site_dict['longitude'] = float(inputs[2])
        site_dict['discount_rate'] = float(inputs[3])
        site_dict['altitude'] = float(inputs[4])
        site_dict['site_area'] = float(inputs[5])
        site_dict['MW_rating'] = float(inputs[6])
        site_dict['timezone'] = str(inputs[7])
        site_dict['dist_substation'] = float(inputs[8])
        site_dict['dist_road'] = float(inputs[9])
        site_dict['flood_risk'] = inputs[10]
