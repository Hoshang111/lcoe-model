...
def calculate_scenarios_iterations(iteration_input_tables, year_start, year_end):
    ...
    year_list = pd.DataFrame(list(range(year_start, year_end)), columns=['Year'])
    ...
    component_usage_by_year_iter['TotalUsageY'] = np.where(((component_usage_by_year_iter[
                                                           ...
                                                           component_usage_by_year_iter['Usage'] * component_usage_by_year_iter['UsageAnnualMultiplier'] ** (component_usage_by_year_iter['Year'] - component_usage_by_year_iter['UsageBaselineYear']),
    ...
    component_usage_by_year_iter['TotalUsageY'] = np.where(
        ...
        component_usage_by_year_iter['InstallNumber'] * component_usage_by_year_iter['Usage'] * component_usage_by_year_iter['UsageAnnualMultiplier'] ** (component_usage_by_year_iter['Year'] - component_usage_by_year_iter['UsageBaselineYear']),
        component_usage_by_year_iter['TotalUsageY'])
