...
satellite_data_2016_path = os.path.join(data_path, "mohesh_2016.csv")
satellite_data_2017_path = os.path.join(data_path, "mohesh_2017.csv")
satellite_data_2018_path = os.path.join(data_path, "mohesh_2018.csv")
satellite_data_2019_path = os.path.join(data_path, "mohesh_2019.csv")
satellite_data_2020_path = os.path.join(data_path, "mohesh_2020.csv")
